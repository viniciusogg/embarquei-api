...
class Version20180904172551 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
...
//
//        $this->addSql('CREATE TABLE pontos_parada (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', trajeto_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', nome VARCHAR(255) NOT NULL, INDEX IDX_7AA975AA5FD436D8 (trajeto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
...
//        $this->addSql('CREATE TABLE motoristas (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', foto VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
//        $this->addSql('CREATE TABLE enderecos (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', cidade VARCHAR(255) NOT NULL, logradouro VARCHAR(255) NOT NULL, bairro VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
...
//        $this->addSql('CREATE TABLE listas_presenca (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', instituicao_ensino_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_F8161059CFA13933 (instituicao_ensino_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
//        $this->addSql('CREATE TABLE trajetos (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', horario_trajeto_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', rota_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', url_mapa VARCHAR(255) NOT NULL, tipo VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_528CA241E5CE6D0 (horario_trajeto_id), INDEX IDX_528CA2419F169B8 (rota_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
//        $this->addSql('CREATE TABLE comprovantes_matricula (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', caminho_sistema_arquivos VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, data_envio DATETIME NOT NULL, justificativa VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
...
//        $this->addSql('CREATE TABLE veiculos_transporte (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', capacidade INT NOT NULL, placa VARCHAR(255) NOT NULL, tipo VARCHAR(255) NOT NULL, cor VARCHAR(255) NOT NULL, imagem VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
//        $this->addSql('CREATE TABLE notificacoes (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', remetente_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', titulo VARCHAR(255) NOT NULL, descricao VARCHAR(255) NOT NULL, tipo VARCHAR(255) NOT NULL, data_envio DATETIME NOT NULL, INDEX IDX_EFFEE10DFA0A674B (remetente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
//        $this->addSql('CREATE TABLE instituicoes_ensino (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', endereco_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', motoristum_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', veiculo_transporte_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', nome VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_165F7F181BB76823 (endereco_id), INDEX IDX_165F7F184FC6F8B6 (motoristum_id), INDEX IDX_165F7F186120DAE4 (veiculo_transporte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
...
//        $this->addSql('CREATE TABLE estudantes (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', curso_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', endereco_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', comprovate_matricula_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', foto VARCHAR(255) NOT NULL, INDEX IDX_E590D4DD87CB4A1F (curso_id), UNIQUE INDEX UNIQ_E590D4DD1BB76823 (endereco_id), UNIQUE INDEX UNIQ_E590D4DD14C583B7 (comprovate_matricula_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
...
//        $this->addSql('ALTER TABLE instituicoes_ensino ADD CONSTRAINT FK_165F7F184FC6F8B6 FOREIGN KEY (motoristum_id) REFERENCES motoristas (id)');
//        $this->addSql('ALTER TABLE instituicoes_ensino ADD CONSTRAINT FK_165F7F186120DAE4 FOREIGN KEY (veiculo_transporte_id) REFERENCES veiculos_transporte (id)');
...
//        $this->addSql('ALTER TABLE instituicoes_ensino DROP FOREIGN KEY FK_165F7F184FC6F8B6');
...
//        $this->addSql('ALTER TABLE instituicoes_ensino DROP FOREIGN KEY FK_165F7F186120DAE4');
