...
class Version20190117220426 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE rotas (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', cidade_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_C067190B9586CC8 (cidade_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trajetos (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', horario_trajeto_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', rota_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', descricao VARCHAR(255) NOT NULL, ativado TINYINT(1) NOT NULL, tipo VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_528CA241E5CE6D0 (horario_trajeto_id), INDEX IDX_528CA2419F169B8 (rota_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE geolocalizacoes (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', lat NUMERIC(10, 8) NOT NULL, lng NUMERIC(11, 8) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE estudantes DROP FOREIGN KEY FK_E590D4DD7ABFA656');
        $this->addSql('ALTER TABLE motoristas DROP FOREIGN KEY FK_5CFD06CD7ABFA656');
        $this->addSql('ALTER TABLE veiculos_transporte DROP FOREIGN KEY FK_ECF39B377ABFA656');
