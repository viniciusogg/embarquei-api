 ...
 */
class Rota extends \App\Entities\Rota implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Rota $proxy) {
    ...
    public function getTrajetos()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTrajetos', []);

        return parent::getTrajetos();
    }
