 ...
 */
class Trajeto extends \App\Entities\Trajeto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Trajeto $proxy) {
    ...
    public function getHorarioTrajeto()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHorarioTrajeto', []);

        return parent::getHorarioTrajeto();
    }
    ...
    public function setHorarioTrajeto($horarioTrajeto)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHorarioTrajeto', [$horarioTrajeto]);

        return parent::setHorarioTrajeto($horarioTrajeto);
    }
